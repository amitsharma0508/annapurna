...
@Component({
  selector: 'app-motor-cp-renewal',
  templateUrl: './motor-cp-renewal.page.html',
  styleUrls: ['./motor-cp-renewal.page.scss'],
})
export class MotorCpRenewalPage implements OnInit {
  status!: string;
  message!: string;
  css!: string;
  loading: any;
  ...
  getMotorInsuranceDetails(){
    ...
    // this.dataService.getMotorMcpInsuranceDetails(this.policyNo).then(res => {
