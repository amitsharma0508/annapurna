...
@Component({
  selector: 'app-motor-tp-renewal-detail',
  templateUrl: './motor-tp-renewal-detail.page.html',
  styleUrls: ['./motor-tp-renewal-detail.page.scss'],
})
export class MotorTpRenewalDetailPage implements OnInit {
  status!: string;
  message!: string;
  css!: string;
  loading: any;
  ...
  //getMotorInsuranceDetails function
  getMotorInsuranceDetails(){
    // this.presentLoading();
    // this.paymentOption = true;
    // this.dataService.getMotorInsuranceDetails(this.policyNo).then(res => {
