...
@Component({
  selector: 'app-trending-prouct2',
  templateUrl: './trending-prouct2.component.html',
  styleUrls: ['./trending-prouct2.component.css']
})
export class TrendingProuct2Component implements OnInit {
  imgSrc: string;
  imgSrc2: string;
  imgSrc3: string;
