...
@Component({
  selector: 'app-trending-prouct3',
  templateUrl: './trending-prouct3.component.html',
  styleUrls: ['./trending-prouct3.component.css']
})
export class TrendingProuct3Component implements OnInit {
  imgSrc: string;
  imgSrc2: string;
  imgSrc3: string;
                        ...
                        .pipe(
                          finalize(() => {
                            fileRef3.getDownloadURL().subscribe((url3) => {
                              ...
                              console.log(formValue);
                              this.service.inserttrendingProducts3Details(this.electronicForm.value);
                              console.log(formValue);
                              this.resetForm();
                            });
                          })
  ...
  resetForm() {
   ...
   deleteGroceryItem(item, itemID) {
    ...
    const groceryListRef = firebase.database().ref("trendingList3");
    let itemKey;
