...
@Component({
  selector: 'app-trending-prouct1',
  templateUrl: './trending-prouct1.component.html',
  styleUrls: ['./trending-prouct1.component.css']
})
export class TrendingProuct1Component implements OnInit {
  imgSrc: string;
  imgSrc2: string;
  imgSrc3: string;
                        ...
                        .pipe(
                          finalize(() => {
                            fileRef3.getDownloadURL().subscribe((url3) => {
                              ...
                              console.log(formValue);
                              this.service.inserttrendingProducts1Details(this.electronicForm.value);
                              console.log(formValue);
                              this.resetForm();
                            });
                          })
  ...
  resetForm() {
   ...
   deleteGroceryItem(item, itemID) {
    ...
    const groceryListRef = firebase.database().ref("trendingList1");
    let itemKey;
